...
<!-- Mirrored from preview.colorlib.com/theme/hospice/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Oct 2022 16:17:30 GMT -->
...
<head>
  ...
  <link rel="stylesheet" href="css/A.style.css%2bresponsive.css%2cMcc.LIJsrza3B-.css.pagespeed.cf.pH71K67LFL.css" />
...
<body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          ...
          <a class="navbar-brand logo_h" href="index-2.html">
            <img src="img/xlogo.png.pagespeed.ic.fTqN_WhrHT.png" alt="">
          </a>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <h1 class="text-dark">We Care for Your Health Every Moment</h1>
            <p class="text-dark">If you are looking at blank cassettes on the web, you may be very confused at the difference in price You
              may see some
              for as low as each.</p>
            <a class="main_btn mr-10" href="#" class="text-dark">get started</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="categories_post">
            <img src="img/procedure/xp1.jpg.pagespeed.ic.1C4bvv7NXW.jpg" alt="Procedure">
        ...
        <div class="col-lg-4">
          <div class="categories_post">
            <img src="img/procedure/xp2.jpg.pagespeed.ic.YmAbCqblfQ.jpg" alt="Procedure">
            <div class="categories_details">
              <div class="categories_text">
                <div class="border_line"></div>
                <a href="single-blog.html">
        ...
        <div class="col-lg-4">
          <div class="categories_post">
            <img src="img/procedure/xp3.jpg.pagespeed.ic.28eDg4wsf9.jpg" alt="Procedure">
            <div class="categories_details">
              <div class="categories_text">
                <div class="border_line"></div>
                <a href="single-blog.html">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pr-0">
          <div class="about_img">
            <img class="img-fluid w-100" src="img/xabout-me.jpg.pagespeed.ic.bm6XxqwqbS.jpg" alt="">
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 pt-60 pb-60">
          <div class="appointment-right">
            <form class="form-wrap" action="#">
              ...
              <input type="text" class="form-control" name="phone" placeholder="Phone " onfocus="this.placeholder = ''"
              ...
              <textarea name="messege" class="" rows="5" placeholder="Messege" onfocus="this.placeholder = ''"
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="single-recent-blog col-lg-4 col-md-4">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="img/xb1.jpg.pagespeed.ic.B09CThk-6B.jpg" alt="">
          </div>
          <a href="#">
        ...
        <div class="single-recent-blog col-lg-4 col-md-4">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="img/xb2.jpg.pagespeed.ic.MdedXieLVA.jpg" alt="">
          </div>
          <a href="#">
        ...
        <div class="single-recent-blog col-lg-4 col-md-4">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="img/xb3.jpg.pagespeed.ic.NbGbVjTtH1.jpg" alt="">
          </div>
          <a href="#">
            <h4>Summer ware are coming</h4>
          </a>
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
    ...
    data-cf-beacon='{"rayId":"75cad242cf93d1e8","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.10.3","si":100}'
    crossorigin="anonymous"></script>
</body>
